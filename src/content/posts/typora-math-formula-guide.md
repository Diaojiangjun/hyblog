...
description: '作为工科专业的，写笔记是一个很常见的事，本篇文章讲述如何使用Typora来记录数学公式，不过在博客中显示的可能对有些符合不太支持'
image: ''
tags: [软件]
category: '笔记'
draft: false 
...
**Typora**是一款轻便简洁的**Markdown编辑器**，支持即时渲染技术，这也是与其他Markdown编辑器最显著的区别。即时渲染使得你写Markdown就想是写Word文档一样流畅自如，不像其他编辑器的有编辑栏和显示栏。
...
- ![image-20260629221451988](_assets/image-20260629221451988.png)
...
>
> `\lVert \boldsymbol{X}_i - \boldsymbol{S}_j \rVert^2` → ∥Xi−Sj∥2
...
| 小写形式 | 大写形式 |  变量形式   |                    显示                    |
| :------: | :------: | :---------: | :----------------------------------------: |
| \epsilon |    E     | \varepsilon |  $ \epsilon \lvert E \lvert \varepsilon $  |
|  \theta  |  \Theta  |  \vartheta  | $ \theta \lvert \Theta \lvert \vartheta $  |
|   \rho   |    P     |   \varrho   |     $ \rho \lvert P \lvert \varrho  $      |
|  \sigma  |  \Sigma  |  \varsigma  | $  \sigma \lvert \Sigma \lvert \varsigma $ |
|   \phi   |   \Phi   |   \varphi   |    $ \phi \lvert \Phi \lvert \varphi  $    |
...
>
> ![b0fe4b234a3fc](_assets/b0fe4b234a3fc.png)
...
| \bigodot | $\bigodot$ | \bigotimes |   $  $   | \bigoplus | $\bigoplus$ |    \leq    |    $\leq$    |
|   \geq   |   $\geq$   |    \neq    |   $  $   |  \approx  |  $\approx$  |   \equiv   |   $\equiv$   |
|   \sum   |   $\sum$   |   \prod    |   $  $   |  \coprod  |  $\coprod$  | \backslash | $\backslash$ |
...
|  输入  |     显示     |    输入    |       显示        |  输入  |    显示     |
| :----: | :----------: | :--------: | :---------------: | :----: | :---------: |
|  \hat  | $\hat {xy}$  |  \widehat  |  $\widehat{xyz}$  |  \bar  |  $\bar{x}$  |
| \tilde | $\tilde{xy}$ | \widetilde | $\widetilde{xyz}$ | \acute | $\acute{y}$ |
| \breve | $\breve{xy}$ |   \check   |    $\check{y}$    | \grave | $\grave{y}$ |
|  \dot  |  $\dot{xy}$  |   \ddot    |    $\ddot{x}$     | \dddot | $\dddot{x}$ |
...
|                      输入                      |                       显示                       |
| :--------------------------------------------: | :----------------------------------------------: |
|          \fbox{a+b+c+d}**高级框选需**          |                 $\fbox{a+b+c+d}$                 |
...
注意比较两个式子间 $dx$ 与 $\begin{array}{cc}{\rm d}x \end{array}$ 的不同。
...
- ![image-20260629221643032](_assets/image-20260629221643032.png)
...
![image-20260629221659466](_assets/image-20260629221659466.png)
...
- 显示：$
  % 此处使用 0.5 倍行高作为边距，附加 2 像素的实线边框（Ctrl+Alt+Y 可见）
  \bbox[#2f3542, 5em, border:2px solid #f1f2f6]{
      \color{#f1f2f6}{e^x=\lim_{n\to\infty} \left( 1+\frac{x}{n} \right)^n \qquad (1)}
  }
  $
- ![image-20260629221939003](_assets/image-20260629221939003.png)
...
- 显示：$$ \mu_0=4\pi\times10^{-7} \ \left.\mathrm{\mathrm{T}\!\cdot\!\mathrm{m}}\middle/\mathrm{A}\right. $$
  $$ 180^\circ=\pi \ \mathrm{rad} $$
  $$ \mathrm{N_A} = 6.022\times10^{23} \ \mathrm{mol}^{-1} $$
...
|  输入  |          显示          |  输入   |          显示           |
| :----: | :--------------------: | :-----: | :---------------------: |
| black  | $\color{blcak}{text}$  |  grey   |  $\color{grey}{text}$   |
...
![image-20260629222828247](_assets/image-20260629222828247.png)
...
| :-----------------------------------------------: | :-------------------------------------------------: | :---------------------------------------------------------: | :-------------------------------------------------: | :-------------------------------------------------: | :-------------------------------------------------: |
| $ \begin{matrix} 1 & 2 \\ 3 & 4 \\ \end{matrix} $ | $ \begin{pmatrix} 1 & 2 \\ 3 & 4 \\ \end{pmatrix} $ | [$ \begin{bmatrix} 1 & 2 \\ 3 & 4 \\ \end{bmatrix} $][1234] | $ \begin{Bmatrix} 1 & 2 \\ 3 & 4 \\ \end{Bmatrix} $ | $ \begin{vmatrix} 1 & 2 \\ 3 & 4 \\ \end{vmatrix} $ | $ \begin{Vmatrix} 1 & 2 \\ 3 & 4 \\ \end{Vmatrix} $ |
...
![image-20260629222950018](_assets/image-20260629222950018.png)
...
![image-20260629223002967](_assets/image-20260629223002967.png)
...
![image-20260629223011798](_assets/image-20260629223011798.png)
